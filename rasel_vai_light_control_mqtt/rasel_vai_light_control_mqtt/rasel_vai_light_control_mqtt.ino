...
const char* password = "rasel101010";

const char* mqtt_server = "202.168.255.20";
const char* mqtt_user = "tipu";
const char* mqtt_pass = "tipu1234";

String RELAY_1_SUB_TOPIC = "rasel/esp8266/home/light";
String RELAY_2_SUB_TOPIC = "rasel/esp8266/home/fan";
...
void setup() {
  ...
  if (client.connect("espClient", mqtt_user, mqtt_pass)) {
    client.subscribe("rasel/esp8266/home/#");
  }
  digitalWrite(LED_BUILTIN, HIGH);
