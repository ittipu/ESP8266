...
#define API_KEY "AIzaSyC1uieGJNx4sD7uS_V3zITL1XyCWYV_3GM"

/* 3. Define the RTDB URL */
#define DATABASE_URL "https://esp8266-firebase-demo-5ce0b-default-rtdb.asia-southeast1.firebasedatabase.app/" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app
...
void loop()
{
  ...
  if (Firebase.ready() && (millis() - sendDataPrevMillis > 15000 || sendDataPrevMillis == 0))
  {
    ...
    json.add("data", "hello");
    json.add("num", count);
    Serial.printf("Set json... %s\n\n", Firebase.setJSON(fbdo, "/test/Sensor", json) ? "ok" : fbdo.errorReason().c_str());
  }
}
